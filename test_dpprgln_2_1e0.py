...
if rank == 0:
    ...
    model.sample(20000)
    model.write_to_disk('./output/dpprgln/results_2_1e0.db', 10000, 2)
    model.complete()

    res = DPPRGLN_Result('./output/dpprgln/results_2_1e0.db')
    res.write_posterior_predictive('./output/dpprgln/postpred_2_1e0.csv')
