...
#
# nohup python test_generic.py ./datasets/ivt_nov_mar.csv ./output dphpg 50000 20000 30 --eta_shape 2 --eta_rate 1e-1 > /dev/null 2>&1 &
# nohup python test_generic.py ./datasets/ivt_nov_mar.csv ./output dphprg 50000 20000 30 --eta_shape 2 --eta_rate 1e-1 > /dev/null 2>&1 &
#
...
#
# nohup python test_generic.py ./datasets/ivt_nov_mar.csv ./output mhpg 50000 20000 30 --nMix 30 > /dev/null 2>&1 &
# nohup python test_generic.py ./datasets/ivt_nov_mar.csv ./output mhprg 50000 20000 30 --nMix 30 > /dev/null 2>&1 &
#
