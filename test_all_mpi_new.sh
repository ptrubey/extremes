...
nohup mpiexec -np 8 python -m mpi4py test_generic_mpi.py ./datasets/ivt_updated_nov_mar.csv ./output2 mhpgln 50000 20000 30 --eta_shape 2 --eta_rate 1e-1 > /dev/null 2>&1 &
nohup mpiexec -np 8 python -m mpi4py test_generic_mpi.py ./datasets/ivt_updated_nov_mar.csv ./output2 mhprgln 50000 20000 30 --eta_shape 2 --eta_rate 1e-1 > /dev/null 2>&1 &
