...
nohup python test_generic.py ./simulated_ad/ad_sim_m5_c5_x.csv ./simulated_ad/m5_c5 dphprg 50000 20000 30 --decluster False > /dev/null 2>&1 &
nohup python test_generic.py ./simulated_ad/ad_sim_m5_c10_x.csv ./simulated_ad/m5_c10 dphprg 50000 20000 30 --decluster False > /dev/null 2>&1 &
nohup python test_generic.py ./simulated_ad/ad_sim_m10_c5_x.csv ./simulated_ad/m10_c5 dphprg 50000 20000 30 --decluster False > /dev/null 2>&1 &
nohup python test_generic.py ./simulated_ad/ad_sim_m10_c10_x.csv ./simulated_ad/m10_c10 dphprg 50000 20000 30 --decluster False > /dev/null 2>&1 &
