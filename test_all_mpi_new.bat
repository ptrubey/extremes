...
start /low cmd /k mpiexec -np 5 python -m mpi4py test_generic_mpi.py ./datasets/ivt_updated_nov_mar.csv ./output2 dphpgln 50000 20000 30 --eta_shape 2 --eta_rate 1e-1
start /low cmd /k mpiexec -np 5 python -m mpi4py test_generic_mpi.py ./datasets/ivt_updated_nov_mar.csv ./output2 dphprgln 50000 20000 30 --eta_shape 2 --eta_rate 1e-1
...
start /low cmd /k mpiexec -np 5 python -m mpi4py test_generic_mpi.py ./datasets/ivt_updated_nov_mar.csv ./output2 mhpgln 50000 20000 30 --eta_shape 2 --eta_rate 1e-1
start /low cmd /k mpiexec -np 5 python -m mpi4py test_generic_mpi.py ./datasets/ivt_updated_nov_mar.csv ./output2 mhprgln 50000 20000 30 --eta_shape 2 --eta_rate 1e-1
