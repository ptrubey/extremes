...
def dprodgamma_log_multi_y(aY, vAlpha, vBeta):
...
def dgamma_log_multi_theta(y, vAlpha, vBeta):
...
def sample_delta_i(curr_delta, i, p, zeta, sigma):
    pass
