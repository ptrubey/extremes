...
if __name__ == '__main__':
    ...
    dpmpg.sample(20000)
    dpmpg.write_to_disk('./output/dpmrpg/results_2_1e1.db', 10000,2)

    res = ResultDPMPG('./output/dpmrpg/results_2_1e1.db')
    res.write_posterior_predictive('./output/dpmrpg/postpred_2_1e1.csv')
