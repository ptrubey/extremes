...
from data import Data_From_Raw, Data_From_Sphere, DataBase, Projection, MixedDataBase, MixedData, RankTransform, euclidean_to_angular,    \
...
class Samples(object):
    ...
    def __init__(self, nSamp, nDat, nCol, nTemp, nTrunc):
        """
        nCol: number of 
...
class Samples_(Samples):
    def __init__(self, nSamp, nDat, nCol, nTrunc):
        tCol = nCol
...
class Chain(ParallelTemperingStickBreakingSampler, Projection):
    ...
    def initialize_sampler(self, ns):
        ...
        self.zeta_shape = (self.nTemp, self.nDat, self.nCol)
        return
    ...
    def __init__(
        ...
        assert (
            (type(data) is Data_From_Raw)
            or (type(data) is Data_From_Sphere)
            or (type(data) is RankTransform)
            )
        self.data = data
...
class Result(object):
    ...
    def load_data(self, path):        
        ...
        self.data = DataBase(V = out['V'], X = out['X'])
        ...
        self.samples = Samples_(
            self.nSamp, self.nDat, self.nCol, self.max_clust_count,
            )
...
if __name__ == '__main__':
    ...
    # p = argparser()
    d = {
        'in_data_path'    : './ad/rank_cover/data.csv',
        'in_outcome_path' : './ad/rank_cover/outcome.csv',
