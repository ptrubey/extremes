...
start /low cmd /k mpiexec -np 5 python -m mpi4py test_generic_mpi.py ./datasets/ivt_nov_mar.csv ./output mhpgln 50000 20000 30 --nMix 30
start /low cmd /k mpiexec -np 5 python -m mpi4py test_generic_mpi.py ./datasets/ivt_nov_mar.csv ./output mhprgln 50000 20000 30 --nMix 30
